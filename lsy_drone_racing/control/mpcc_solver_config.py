...
class MPCCSolverConfig:
    ...
    model_traj_length: float = 9
    delta_theta: float = 0.05

    # MPCC progress params
    # Tracking cost 
    q_lag: float = 50.0              # Lag error weight at gates
    q_lag_peak: float = 500
    q_contour: float = 100.0          # Contour error weight at gates
    q_contour_peak: float = 750
    q_attitude: float = 1.0

    # Control smoothness
    r_thrust: float = 0.3                  # Thrust rate penalty
